...
def lsl_timestamp_diffs(csv_filepath: str, start_value: int, end_value: int, show: bool):
    """
    ...
    -----------
        ...
        show (bool): The bool value to determine whether to show the statistics or not.
    """
    data = load_csv(csv_filepath, "lsl_timestamp")
...
if __name__ == "__main__":
    ...
    lsl_timestamp_diffs(args.filepath, args.start, args.end, args.show)
